            ...
            @foreach ($content as $item)
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div class="card ne-card">
                        ...
                        <div class="card-body">
                            <a href="{{ UrlRoutes::series($item->series_id) }}" class="card-title ne-title">
                                {{ $item->series_title }}
                            </a>

                            <p class="card-text ne-short-description">
                                {{ Utilities::excerpt($item->series_description, 120, "...") }}
                            </p>

                            <a href="{{ UrlRoutes::series($item->series_id) }}" class="ne-btn">
                                {{ __('Watch') }}
                            </a>
